    ...
    div
      .uk-section.uk-section-large.uk-position-relative
        .uk-container.uk-text-center(v-if="content.primary")
          ...
          .uk-margin
            nuxt-link.light-button.uk-display-inline-block(:to="$prismic.asLink(content.primary.link)", v-if='$prismic.asLink(content.primary.seccion_link)') {{ $prismic.asText(content.primary.link_texto) }} #[span.uk-icon(uk-icon="minus") ]
        .uk-height-medium
</template>
